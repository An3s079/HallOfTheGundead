...
namespace HallOfGundead
{
	public class HallDungeonFlows
    {
        ...
        public static SharedInjectionData HallInjectionData;
        ...
        public static ProceduralFlowModifierData SecretHallEntranceInjector;
        ...
        public static void InitDungeonFlows(bool refreshFlows = true)
        {
            ...
            BaseSharedInjectionData = HallPrefabs.shared_auto_002.LoadAsset<SharedInjectionData>("Base Shared Injection Data");
            ...
            SecretHallEntranceInjector = new ProceduralFlowModifierData()
            {
                ...
                exactRoom = HallRoomPrefabs.Hollow_Pumpkin_Room,
                IsWarpWing = true,
            ...
            HollowsInjectionData.InjectionData.Add(SecretHallEntranceInjector);

            // Don't build/add flows until injection data is created!
            Foyer_Flow = FlowHelpers.DuplicateDungeonFlow(HallPrefabs.shared_auto_002.LoadAsset<DungeonFlow>("Foyer Flow"));

            // List<DungeonFlow> m_knownFlows = new List<DungeonFlow>();
            KnownFlows = new List<DungeonFlow>();

            KnownFlows.Add(f1b_hall_flow_01.F1b_Hall_Flow_01());
