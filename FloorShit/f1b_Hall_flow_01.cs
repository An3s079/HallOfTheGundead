...
namespace HallOfGundead {
    ...
    public class f1b_hall_flow_01 : HallDungeonFlows {
        
        public static DungeonFlow F1b_Hall_Flow_01() {
            try
            {
				...
				DungeonFlowNode entranceNode = GenerateDefaultNode(m_CachedFlow, PrototypeDungeonRoom.RoomCategory.NORMAL, HallRoomPrefabs.Hall_Entrance_Room);
				DungeonFlowNode exitNode = GenerateDefaultNode(m_CachedFlow, PrototypeDungeonRoom.RoomCategory.NORMAL, HallRoomPrefabs.Hall_Exit_Room);
				DungeonFlowNode bossfoyerNode = GenerateDefaultNode(m_CachedFlow, PrototypeDungeonRoom.RoomCategory.SPECIAL, overrideTable: HallPrefabs.boss_foyertable);
				DungeonFlowNode bossNode = GenerateDefaultNode(m_CachedFlow, PrototypeDungeonRoom.RoomCategory.BOSS, HallRoomPrefabs.Hall_Boss);

				DungeonFlowNode JungleShopNode = GenerateDefaultNode(m_CachedFlow, HallPrefabs.shop02.category, overrideTable: HallPrefabs.shop_room_table);
				DungeonFlowNode JungleRewardNode_01 = GenerateDefaultNode(m_CachedFlow, PrototypeDungeonRoom.RoomCategory.CONNECTOR, HallPrefabs.gungeon_rewardroom_1);
				DungeonFlowNode JungleRewardNode_02 = GenerateDefaultNode(m_CachedFlow, PrototypeDungeonRoom.RoomCategory.CONNECTOR, HallPrefabs.gungeon_rewardroom_1);
				...
				m_CachedFlow.name = "F1b_Hall_Flow_01";
				m_CachedFlow.fallbackRoomTable = HallPrefabs.HallRoomTable;
