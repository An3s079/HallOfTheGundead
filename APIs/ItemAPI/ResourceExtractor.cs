...
namespace ItemAPI
{
    public static class ResourceExtractor
    {
        ...
        public static string BuildStringFromEmbeddedResource(string filePath)
        {
            ...
            filePath = filePath.Replace("\\", ".");
            if (BytesToString(ExtractEmbeddedResource(filePath)) == null)
            {
                Tools.PrintError("No bytes found in: " + filePath);
                return null;
            }
                return BytesToString(ExtractEmbeddedResource(filePath));
        }
