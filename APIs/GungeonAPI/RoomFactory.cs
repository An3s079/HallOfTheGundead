...
namespace GungeonAPI
{
	...
	public static class RoomFactory
	{
        ...
        public static void ApplyRoomData(PrototypeDungeonRoom room, RoomData roomData, bool setRoomCategory, bool autoAssignToFloor, bool assignDecorationProperties, float? Weight)
        {
            ...
            if (autoAssignToFloor && roomData.floors != null)
            {
                ...
                if (room.category == PrototypeDungeonRoom.RoomCategory.SECRET)
                {
                    ...
                    HallOfGundead.HallPrefabs.SecretRoomTable.includedRooms.elements.Add(HallOfGundead.HallRoomPrefabs.GenerateWeightedRoom(room, Weight.Value));
                }
                else
                {
        ...
        public static void AssignRoomToFloorRoomTable(PrototypeDungeonRoom Room, GlobalDungeonData.ValidTilesets targetTileSet, float? Weight)
        {
            ...
            {
                HallOfGundead.HallPrefabs.CastleRoomTable.includedRooms.elements.Add(HallOfGundead.HallRoomPrefabs.GenerateWeightedRoom(Room, Weight.Value));
            }
            else if (targetTileSet == GlobalDungeonData.ValidTilesets.SEWERGEON)
            {
                HallOfGundead.HallPrefabs.SewersRoomTable.includedRooms.elements.Add(HallOfGundead.HallRoomPrefabs.GenerateWeightedRoom(Room, Weight.Value));
            }
            else if (targetTileSet == GlobalDungeonData.ValidTilesets.GUNGEON)
            {
                HallOfGundead.HallPrefabs.Gungeon_RoomTable.includedRooms.elements.Add(HallOfGundead.HallRoomPrefabs.GenerateWeightedRoom(Room, Weight.Value));
            }
            else if (targetTileSet == GlobalDungeonData.ValidTilesets.CATHEDRALGEON)
            {
                HallOfGundead.HallPrefabs.AbbeyRoomTable.includedRooms.elements.Add(HallOfGundead.HallRoomPrefabs.GenerateWeightedRoom(Room, Weight.Value));
            }
            else if (targetTileSet == GlobalDungeonData.ValidTilesets.MINEGEON)
            {
                HallOfGundead.HallPrefabs.MinesRoomTable.includedRooms.elements.Add(HallOfGundead.HallRoomPrefabs.GenerateWeightedRoom(Room, Weight.Value));
            }
            else if (targetTileSet == GlobalDungeonData.ValidTilesets.CATACOMBGEON)
            {
                HallOfGundead.HallPrefabs.CatacombsRoomTable.includedRooms.elements.Add(HallOfGundead.HallRoomPrefabs.GenerateWeightedRoom(Room, Weight.Value));
            }
            ...
            {
                HallOfGundead.HallPrefabs.ForgeRoomTable.includedRooms.elements.Add(HallOfGundead.HallRoomPrefabs.GenerateWeightedRoom(Room, Weight.Value));
            }
            else if (targetTileSet == GlobalDungeonData.ValidTilesets.HELLGEON)
            {
                HallOfGundead.HallPrefabs.BulletHellRoomTable.includedRooms.elements.Add(HallOfGundead.HallRoomPrefabs.GenerateWeightedRoom(Room, Weight.Value));
            }
            return;
        }
        ...
        {
            if (HallOfGundead.HallPrefabs.shared_auto_001.LoadAsset<GameObject>(assetPath))
            {
                return HallOfGundead.HallPrefabs.shared_auto_001.LoadAsset<GameObject>(assetPath);
            }
            else if (HallOfGundead.HallPrefabs.shared_auto_002.LoadAsset<GameObject>(assetPath))
            {
                return HallOfGundead.HallPrefabs.shared_auto_002.LoadAsset<GameObject>(assetPath);
            }
            else if (HallOfGundead.HallPrefabs.braveResources.LoadAsset<GameObject>(assetPath))
            {
                return HallOfGundead.HallPrefabs.braveResources.LoadAsset<GameObject>(assetPath);
            }
            else
            {
                return null;
        ...
        {
            if (HallOfGundead.HallPrefabs.shared_auto_001.LoadAsset<DungeonPlaceable>(assetPath))
            {
                return HallOfGundead.HallPrefabs.shared_auto_001.LoadAsset<DungeonPlaceable>(assetPath);
            }
            else if (HallOfGundead.HallPrefabs.shared_auto_002.LoadAsset<DungeonPlaceable>(assetPath))
            {
                return HallOfGundead.HallPrefabs.shared_auto_002.LoadAsset<DungeonPlaceable>(assetPath);
            }
            else if (HallOfGundead.HallPrefabs.braveResources.LoadAsset<DungeonPlaceable>(assetPath))
            {
                return HallOfGundead.HallPrefabs.braveResources.LoadAsset<DungeonPlaceable>(assetPath);
            }
            else
            {
                return null;
